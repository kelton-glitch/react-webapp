...
class WorkExperience extends Component {
        ...
        <React.Fragment>
          {this.state.table ? (
            this.state.editForm ? (
                ...
                onWorkExperienceEditUpdate={this.handleWorkExperienveEditUpdate}
    ...
    handleWorkExperienceSubmit = event => {
        ...
        axios
            .post(
                process.env.REACT_APP_API_URL + "/api/work-experience/" + this.props.data["_id"], body, {
                    headers: {
    ...
    handleWorkExperienveEditUpdate = (info, newInfo) =>{
