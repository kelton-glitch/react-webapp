...
class LeaveApplicationHR extends Component {
            ...
            <React.Fragment>
                ...
                {this.state.table ? (
                    this.state.editForm ? (
                        ...
                        onAddLeaveApplicationHR={this.handleLeaveApplicationHREditUpdate}
                        onFormEditClose={this.handleEditFormClose}
    ...
    handleLeaveApplicationHRSubmit = event => {
        ...
        console.log("id",event.target[0].value, event.table[1].value);
    ...
    handleLeaveApplicationHREditUpdate = (info,newInfo) => {
        ...
        axios
            .put(process.env.REACT_APP_API_URL + "/api/leave-application-hr/" + info["_id"],
            body, {
                headers : {
                    authorization: localStorage.getItem("token") || ""
                }
